      ...
      <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="flex items-start gap-2.5 flex-1">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Accra, Ghana – West Africa Headquarters
              </p>
            </div>
          </motion.div>
        ...
        <motion.div className="flex flex-col md:flex-row justify-between items-center gap-4 py-4 border-t border-zinc-300">
          <p className="text-sm text-zinc-500">
            &copy; {new Date().getFullYear()} Camphix Enterprise. All Rights Reserved.
          </p>

          <div className="flex flex-wrap justify-center gap-5 md:gap-9">
            <a href="#" className="text-sm text-zinc-500 hover:text-zinc-700 transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-sm text-zinc-500 hover:text-zinc-700 transition-colors">
              Terms of Service
