...
const App = () => {
  return (
    <>
      ...
      >
        <div className="max-w-full mx-auto bg-linear-to-b bg-gray-50 px-8 py-12 md:py-20  bg-cover bg-center bg-no-repeat">
          <div className="text-center">
            <h1 className="text-3xl md:text-5xl/14 leading-tight font-semibold tracking-tighter max-w-xl mx-auto mb-4">
              Our Story{" "}
              <span className="bg-linear-to-r from-[#e0e0e0] to-[#666666] bg-clip-text text-transparent">
            ...
            <button className="bg-linear-to-b from-[#1E1E1E] to-[#050505] text-white text-sm px-6 py-3 rounded-lg border border-[#242424] inline-flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer group">
              <a
                href="tel:0541728294"
                className="relative overflow-hidden inline-flex items-center gap-2 justify-center h-6 group"
              >
                {/* TEXT WRAP */}
