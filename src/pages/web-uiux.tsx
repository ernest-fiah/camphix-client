...
export default function WebsiteUIUXDesign() {
  /* ===========================
     GALLERY DATA
  =========================== */
  const categories = [
  ...
  const galleryItems = [
    {
      ...
      image: "public/assets/uiuxdesign/1.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/2.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/3.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/4.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/5.jpg",
      bg: "bg-[#5b4636]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/6.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/7.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/8.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/9.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Website & UI/UX Design",
      image: "public/assets/uiuxdesign/10.jpg",
      bg: "bg-[#5b4636]",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-5 sm:mt-7 text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
              ...
              performance to build digital products
              that not only look great but also
              deliver seamless user experiences and
              business results.
            </p>
          ...
          >
            ...
            <div className="relative z-10 bg-[#374151] rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-5 shadow-2xl w-full max-w-xl mx-auto">
              <img
                src="public/assets/uiuxdesign/hero.jpg"
            ...
            >
              ...
              <p className="text-orange-100 text-sm sm:text-base mt-2 sm:mt-3 leading-6 sm:leading-7 text-justify">
                Responsive websites, UI systems,
                wireframes, prototypes, and user-
                centered design experiences built for
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 pb-14 sm:pb-20 md:pb-24 lg:pb-28">
        ...
        >
          ...
          <p className="mt-5 sm:mt-7 max-w-4xl mx-auto text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
            Our design services help businesses
            create visually appealing, user-friendly
            and conversion-optimized digital
            experiences that strengthen brand
          ...
          {[
            {
              ...
              text:
                "We craft clean, modern and visually appealing interfaces that reflect your brand identity.",
            },
            {
              icon: "📱",
              title: "Fully Responsive Layouts",
              text:
                "Your website will look and function perfectly across all devices and screen sizes.",
            },
            {
              icon: "⚡",
              title: "Better User Experience",
              text:
                "We focus on usability and flow to ensure users interact easily and convert faster.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
