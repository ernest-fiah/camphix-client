  ...
  const galleryItems = [
    {
      ...
      image: "public/assets/construction/land-surveying/1.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/2.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/3.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/4.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/5.jpg",
      bg: "bg-[#5b4636]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/6.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/7.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/8.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/9.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Land Surveying & Consultancy",
      image: "public/assets/construction/land-surveying/10.jpg",
      bg: "bg-[#5b4636]",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-10 bg-[#374151] rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-5 shadow-2xl w-full max-w-xl mx-auto border border-white/10"
            >
              <img
                src="public/assets/construction/land-surveying/1.jpg"
                alt="Land Surveying"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {visibleCards.map((item, index) => (
                <motion.div
                  ...
                  className={`${item.bg} rounded-[28px] p-5 h-[250px] sm:h-[400px] overflow-hidden shadow-xl border border-white/10`}
                >
                  <motion.div
                    animate={{
                      boxShadow: [
                    ...
                    className="w-full h-full rounded-[24px] overflow-hidden bg-white/10 border border-white/15"
                  >
                    <img
                      src={item.image}
                      alt={item.title}
