  ...
  const galleryItems = [
    {
      ...
      image: "public/assets/digitalmarketing/1.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/2.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/3.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/4.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/5.jpg",
      bg: "bg-[#5b4636]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/6.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/7.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/8.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/9.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Digital Marketing",
      image: "public/assets/digitalmarketing/10.jpg",
      bg: "bg-[#5b4636]",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-5 sm:mt-7 text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
              ...
              generate qualified leads. We combine
              strategy, creativity, data analysis,
              and performance marketing to ensure
              your business reaches the right
          ...
          >
            ...
            <div className="relative z-10 bg-[#374151] rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-5 shadow-2xl w-full max-w-xl mx-auto">
              <img
                src="public/assets/digitalmarketing/hero.jpg"
            ...
            >
              ...
              <p className="text-orange-100 text-sm sm:text-base mt-2 sm:mt-3 leading-6 sm:leading-7 text-justify">
                SEO, social media marketing, paid ads,
                content strategy, email marketing and
                analytics-focused campaigns designed
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 pb-14 sm:pb-20 md:pb-24 lg:pb-28">
        ...
        >
          ...
          <p className="mt-5 sm:mt-7 max-w-4xl mx-auto text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
            Our digital marketing services help
            businesses increase online visibility,
            attract targeted customers, and convert
          ...
          {[
            {
              ...
              text:
                "We use analytics and insights to create campaigns that deliver measurable and scalable results.",
            },
            {
              icon: "🚀",
              title: "Increased Online Visibility",
              text:
                "Boost your brand presence across search engines, social media platforms, and digital channels.",
            },
            {
              icon: "💡",
              title: "Higher Conversion Rates",
              text:
                "We optimize campaigns to turn visitors into paying customers through targeted marketing funnels.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
