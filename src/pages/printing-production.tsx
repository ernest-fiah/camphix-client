...
export default function PrintingProduction() {
  /* ===========================
     GALLERY DATA
  =========================== */
  const categories = [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-5 sm:mt-7 text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
              ...
              materials to marketing prints and
              large-scale production, we deliver
              sharp, professional, and visually
              impactful results that enhance your
              brand identity.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="text-orange-100 text-sm sm:text-base mt-2 sm:mt-3 leading-6 sm:leading-7 text-justify">
                ...
                and professional print production
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 pb-14 sm:pb-20 md:pb-24 lg:pb-28">
        ...
        >
          ...
          <p className="mt-5 sm:mt-7 max-w-4xl mx-auto text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
            Our printing and production services
            ensure your brand communicates
            professionally through high-quality
            physical materials that leave a lasting
          ...
          {[
            {
              ...
              text:
                "We deliver sharp, vibrant and high-resolution prints that elevate your brand presentation.",
            },
            {
              icon: "🏷️",
              title: "Strong Brand Identity",
              text:
                "Consistent and professional print materials help reinforce your brand across all touchpoints.",
            },
            {
              icon: "📦",
              title: "Complete Production Solutions",
              text:
                "From design to final production, we handle everything for seamless execution and delivery.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
