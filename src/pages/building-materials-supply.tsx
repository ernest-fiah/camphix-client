...
export default function BuildingMaterialsSupply() {
  /* ===========================
     GALLERY DATA
  =========================== */
          ...
          >
            ...
            >
              ...
              <p className="text-orange-100 text-sm sm:text-base mt-2 sm:mt-3 leading-6 sm:leading-7 text-justify">
                Cement, steel, blocks, roofing sheets, fittings and
                construction essentials delivered on schedule.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 pb-14 sm:pb-20 md:pb-24 lg:pb-28">
        ...
        >
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
            <span className="text-yellow-600">Benefits</span> of Building
            Materials Supply
          </h2>
          ...
          <p className="mt-5 sm:mt-7 max-w-4xl mx-auto text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
            Our material supply services help contractors, developers and
            property owners access dependable products, reduce delays and
            complete projects with quality materials at competitive rates.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-7 md:gap-10 mt-12 sm:mt-16 md:mt-20">
            ...
            <div>
              ...
              <div className="border-t border-gray-300 pt-5 sm:pt-7">
                <p className="text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 text-gray-700 text-justify">
                  We supply durable and certified materials that improve
                  structural integrity and project lifespan.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div>
              ...
              <div className="border-t border-gray-300 pt-5 sm:pt-7">
                <p className="text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 text-gray-700 text-justify">
                  Our logistics network ensures materials reach your site
                  promptly to prevent construction delays.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div>
              ...
              <div className="border-t border-gray-300 pt-5 sm:pt-7">
                <p className="text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 text-gray-700 text-justify">
                  We provide cost-effective supply solutions without
                  compromising product quality or reliability.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 pb-20">
          ...
          >
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold leading-tight mt-10">
              Take a look at some of our Building Materials Supply work
            </h2>
          </motion.div>
