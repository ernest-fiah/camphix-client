  ...
  const galleryItems = [
    {
      ...
      image: "public/assets/videography/1.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/2.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/3.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/4.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/5.jpg",
      bg: "bg-[#5b4636]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/6.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/7.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/8.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/9.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Videography & Media Production",
      image: "public/assets/videography/10.jpg",
      bg: "bg-[#5b4636]",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="relative z-10 bg-[#374151] rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-5 shadow-2xl w-full max-w-xl mx-auto">
              <img
                src="public/assets/videography/hero.jpg"
