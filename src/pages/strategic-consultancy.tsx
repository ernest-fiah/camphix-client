  ...
  const galleryItems = [
    {
      ...
      image: "public/assets/strategicconsultancy/1.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/2.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/3.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/4.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/5.jpg",
      bg: "bg-[#5b4636]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/6.jpg",
      bg: "bg-[#2a2540]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/7.jpg",
      bg: "bg-[#00323f]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/8.jpg",
      bg: "bg-[#00365c]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/9.jpg",
      bg: "bg-[#374151]",
    },
    {
      title: "Strategic Consultancy",
      image: "public/assets/strategicconsultancy/10.jpg",
      bg: "bg-[#5b4636]",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-5 sm:mt-7 text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
              ...
              achieve sustainable growth. We analyze
              your business environment, identify
          ...
          >
            ...
            <div className="relative z-10 bg-[#374151] rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-5 shadow-2xl w-full max-w-xl mx-auto">
              <img
                src="public/assets/strategicconsultancy/hero.jpg"
            ...
            >
              ...
              <p className="text-orange-100 text-sm sm:text-base mt-2 sm:mt-3 leading-6 sm:leading-7 text-justify">
                ...
                optimization, business planning, and
                strategic advisory for long-term
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 pb-14 sm:pb-20 md:pb-24 lg:pb-28">
        ...
        >
          ...
          <p className="mt-5 sm:mt-7 max-w-4xl mx-auto text-[0.97rem] sm:text-lg md:text-xl leading-7 sm:leading-9 md:leading-10 text-gray-700 text-justify">
            ...
            make smarter decisions, reduce risks,
            and implement strategies that drive
            long-term success and competitive
            advantage.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              text:
                "We develop actionable strategies that support sustainable growth and scalability.",
            },
            {
              icon: "🧠",
              title: "Expert Business Insights",
              text:
                "We analyze market trends and business data to guide informed decision-making.",
            },
            {
              icon: "⚙️",
              title: "Operational Efficiency",
              text:
                "We help streamline processes to improve productivity and reduce operational costs.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
